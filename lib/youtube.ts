...
async function fetchViaSupadata(
  ...
  return { segments, availableTracks, videoId };
}
...
export async function fetchTranscript(
  ...
  try {
    const { tracks, rawTracks } = await innertubePlayer(videoId, languageCode);
  ...
  // Both methods failed — throw the original InnerTube error (more descriptive)
